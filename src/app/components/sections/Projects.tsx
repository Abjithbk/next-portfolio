  ...
  const projects = [
    {
      ...
      description: "A secure, transparent financial platform for community groups. Features real-time ledgers, role-based access, and automated reporting.",
      image: "https://placehold.co/600x400/051424/00f0ff?text=Banking+System",
    ...
    },
    {
      ...
      description: "Integrated with Judge0 API for real-time code execution. Includes user dashboards, problem sets, and performance leaderboards.",
      image: "https://placehold.co/600x400/051424/b829dd?text=Coding+Platform",
    ...
    },
    {
      ...
      description: "Built using Socket.io and Redis for seamless, sub-second communication. Features end-to-end encryption and persistent message history.",
      image: "https://placehold.co/600x400/051424/2962ff?text=Chat+Engine",
    ...
    },
    {
      ...
      description: "A data visualization tool that uses D3.js to render interactive charts. Helps educators track student performance trends efficiently.",
      image: "https://placehold.co/600x400/051424/00f0ff?text=Grade+Analyzer",
