...
export default function ContactSection() {
  return (
    <section id="contact" className="section js-reveal">
      <h2>Contact</h2>
      <div className="glass-card glass glass-hover contact-wrap">
        <div>
        ...
        <form className="contact-form">
          ...
          <button type="button" className="cta-primary glass-hover">
